...
export default function Home() {
  ...
  const content = {
    tr: {
      ...
      basic_title: "Basic",
      basic_price: "100₺",
      basic_features: ["✅ 3 Fotoğraf Limiti", "✅ Hazır Müzik Listesi", "✅ Standart Tema"],
      premium_title: "Premium",
      premium_price: "250₺",
      premium_features: ["✅ 10 Fotoğraf Limiti", "✅ Kendi Şarkını Yükle (MP3)", "✅ Standart Tema"],
      deluxe_title: "Deluxe",
      deluxe_price: "500₺",
      deluxe_features: ["✅ Sınırsız Fotoğraf", "✅ Video Desteği 🎥", "✅ Kendi Şarkını Yükle", "✅ Şifreli Giriş Özelliği 🔒"],
    ...
    en: {
      ...
      basic_title: "Basic",
      basic_price: "$10",
      basic_features: ["✅ 3 Photos Limit", "✅ Preset Music Only", "✅ Standard Theme"],
      premium_title: "Premium",
      premium_price: "$25",
      premium_features: ["✅ 10 Photos Limit", "✅ Custom Music Upload", "✅ Standard Theme"],
      deluxe_title: "Deluxe",
      deluxe_price: "$50",
      deluxe_features: ["✅ Unlimited Photos", "✅ Video Support 🎥", "✅ Custom Music Upload", "✅ Password Protection 🔒"],
